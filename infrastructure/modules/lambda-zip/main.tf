resource "aws_lambda_function" "lambda" {
  ...
  publish          = true
  filename         = data.archive_file.integration_test_lambda_function_archive.output_path
  handler          = "handler.request"
  source_code_hash = data.archive_file.integration_test_lambda_function_archive.output_base64sha256
  runtime          = "python3.8"
  timeout          = var.timeout
