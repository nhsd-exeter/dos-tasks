module "symptomdiscriminatorsynonyms_lambda" {
  source             = "../../modules/lambda"
  name               = "hk-symptomdiscriminatorsynonyms"
  image_uri          = "${var.aws_lambda_ecr}/${var.project_group_short}/${var.project_name_short}/hk-symptomdiscriminatorsynonyms:${var.image_version}"
