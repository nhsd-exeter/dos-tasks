...
def test_process_scenario(mock_disposition, mock_disposition_group, mock_validator, mock_db_connect):
...
def test_process_zipfile(mock_disposition, mock_disposition_group, mock_validator, mock_db_connect):
...
@patch(f"{file_path}.get_disposition_group_id",return_value=5)
@patch(f"{file_path}.get_disposition_id",return_value=5)
def test_process_zipfile_with_folder(mock_disposition, mock_disposition_group, mock_validator, mock_db_connect):
    scenario_count = handler.initialise_count()
...
def test_get_scenario_insert_query( mock_disposition, mock_disposition_group, mock_validator, mock_db_connect):
...
@patch(f"{file_path}.get_disposition_group_id",return_value=7)
@patch(f"{file_path}.get_disposition_id",return_value=8)
def test_validate_template_scenario_invalid_disposition(mock_disposition, mock_disposition_group, mock_logger, mock_validator, mock_db_connect):
    template_scenario = handler.process_scenario_file(env, sample_scenario_file_name,convert_file_to_stream(sample_scenario_file_name),bundle_id, mock_db_connect)
...
@patch(f"{file_path}.get_disposition_group_id",return_value=7)
@patch(f"{file_path}.get_disposition_id",return_value=8)
def test_validate_template_scenario_invalid_disposition_group(mock_disposition, mock_disposition_group, mock_logger, mock_validator, mock_db_connect):
    template_scenario = handler.process_scenario_file(env, sample_scenario_file_name,convert_file_to_stream(sample_scenario_file_name),bundle_id, mock_db_connect)
...
@patch(f"{file_path}.get_disposition_group_id",return_value=7)
@patch(f"{file_path}.get_disposition_id",return_value=8)
def test_validate_template_scenario_invalid_symptom_discriminator(mock_disposition, mock_disposition_group, mock_logger, mock_validator, mock_db_connect):
    template_scenario = handler.process_scenario_file(env, sample_scenario_file_name,convert_file_to_stream(sample_scenario_file_name),bundle_id, mock_db_connect)
    valid_template = handler.validate_template_scenario(env, template_scenario)
    assert valid_template == False
    assert mock_logger.call_count == 1
